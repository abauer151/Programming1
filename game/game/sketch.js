...
let xdirection1 = 1.82; //changes bounce direction
let ydirection1 = 1.23;
let xdirection2 = 1.61;
let ydirection2 = 1.74;
let xdirection3 = 1.82;
let ydirection3 = 1.53;
let xdirection4 = 1.46;
let ydirection4 = 1.18;
let xdirection5 = 1.93;
let ydirection5 = 1.05;
let xdirection6 = 1.43;
let ydirection6 = 1.81;
...
function draw(){
	...
	if (xpos1 > width - rad +200|| xpos1 < rad-200) {
		xdirection1 *= -1.01;	
	}
	if (ypos1> height - rad +200 || ypos1 < rad-200) {
	...
	if (xpos2 > width - rad +200|| xpos2 < rad-200) {
		xdirection2 *= -1.01;	
	}
	if (ypos2 > height - rad +200 || ypos2 < rad-200) {
	...
	if (xpos3 > width - rad +200|| xpos3 < rad-200) {
		xdirection3 *= -1.01;	
	}
	if (ypos3 > height - rad +200 || ypos3 < rad-200) {
	...
	if (xpos4 > width - rad +200|| xpos4 < rad-200) {
		xdirection4 *= -1.01;	
	}
	if (ypos4 > height - rad +200 || ypos4 < rad-200) {
	...
	if (xpos5 > width - rad +200|| xpos5 < rad-200) {
		xdirection5 *= -1.01;	
	}
	if (ypos5 > height - rad +200 || ypos5 < rad-200) {
	...
	if (xpos6 > width - rad +200|| xpos6 < rad-200) {
		xdirection6 *= -1.01;	
	}
	if (ypos6 > height - rad +200 || ypos6 < rad-200) {
